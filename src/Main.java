...
public class Main {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println(Arrays.toString(bd.getInfo("example.com.",(byte) 0)));
        System.out.println(Arrays.toString(bd.getInfo("example.com.",(byte) 1)));
        System.out.println(Arrays.toString(bd.getInfo("example.com.",(byte) 2)));
        System.out.println(Arrays.toString(bd.getInfo("example.com.",(byte) 3)));
        System.out.println(Arrays.toString(bd.getInfo("example.com.",(byte) 4)));
        System.out.println(Arrays.toString(bd.getInfo("example.com.",(byte) 5)));
        System.out.println(Arrays.toString(bd.getInfo("example.com.",(byte) 6)));
        System.out.println(Arrays.toString(bd.getInfo("example.com.",(byte) 7)));
        System.out.println(Arrays.toString(bd.getInfo("mail1.example.com.",(byte) 8)));
        System.out.println(Arrays.toString(bd.getInfo("example.com.",(byte) 9)));
